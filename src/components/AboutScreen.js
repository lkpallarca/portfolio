  ...
  return (
    <section className='about-screen'>
      ...
      <div className='about-body'>
        ...
        <div>
          I am a person who is passion driven.
        ...
        <div>
          Fast forward to today, I've had the opportunity to be taken under the wing of an awesome <a href='https://www.avionschool.com/' target='blank'>bootcamp</a>. My main focus these days is expanding my network while absorbing as much as I can from as many software devs as possible.
        </div> 
        <div>
